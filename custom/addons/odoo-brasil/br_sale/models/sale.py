...
class SaleOrderLine(models.Model):
    ...
    def _prepare_invoice_line(self, qty):
        ...
        #Gambiarra Contador
        vta = self.tax_id.filtered(lambda x: x.domain == 'outros')
        ...
        if self.product_id.fiscal_type == 'service':
            ...
            if vtax == 0:
                ...
                res['tributos_estimados_federais'] = self.price_subtotal * (vtax/100)
                res['tributos_estimados_estaduais'] = 0
                res['tributos_estimados_municipais'] = 0
